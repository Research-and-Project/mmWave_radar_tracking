...
if ~isTrackInitialized
  ...
  if ~isempty(meas_loc) % The obj was detected.
	...
	% correct.
	predict(cur_KF); % this will update cur_KF.State and return predicted loc
	kf_loc = correct(cur_KF, meas_loc); % this will update cur_KF.State and return correct loc
